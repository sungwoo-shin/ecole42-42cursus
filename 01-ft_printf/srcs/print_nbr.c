...
/*   Updated: 2021/09/26 21:12:31 by sshin            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int		print_zero_by_prec(t_info *info, int len_to_print_nbr)
{
...
static int		print_nbr_by_type(size_t nbr, t_info *info)
{
	char		*buf;
	char		*baseset;
	size_t		nbr_backup;
...
static int		print_nbr_by_prec(size_t nbr, t_info *info, int len_to_print_nbr)
{
	int		ret;
