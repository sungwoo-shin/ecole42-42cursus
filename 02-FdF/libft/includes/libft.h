...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/05/04 17:29:40 by sshin             #+#    #+#             */
/*   Updated: 2021/08/17 21:39:06 by sshin            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
# define GET_LESS(A, B) (((A) < (B)) ? (A) : (B))
# define GET_GREATER(A, B) (((A) > (B)) ? (A) : (B))
...
bool				is_spc(char c);
char				**split_into_strs(char const *s, char c);
